...
__STATIC_FORCEINLINE void __nx_stm32_invalidate_cache_by_addr(uint32_t start, uint32_t size)
{
...
#define clean_cache_by_addr(__ptr__, __size__)                       __nx_stm32_clean_cache_by_addr((uint32_t)(__ptr__), (uint32_t)(__size__))
#else
